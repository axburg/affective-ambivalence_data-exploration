...
###Testing the correlation of symbolic ideology with affective ambivalence

##Merkel

#Wave4
cor.test(symb_id_w4, Merkel_amb_w4, use ="complete.obs") # negative correlation: r = -.07
#Wave6
cor.test(symb_id_w6, Merkel_amb_w6, use ="complete.obs") # negative correlation: r = -.10

##Schulz

#Wave4
cor.test(symb_id_w4, Schulz_amb_w4, use ="complete.obs") # negative correlation: r = -.08
#Wave6
cor.test(symb_id_w6, Schulz_amb_w6, use ="complete.obs") # negative correlation: r = -.09

##Average Ambivalence

#Wave4
cor.test(symb_id_w4, mean_amb_w4, use ="complete.obs") # negative correlation: r = -.08
#Wave6
cor.test(symb_id_w6, mean_amb_w6, use ="complete.obs") # negative correlation: r = -.11

###Testing the correlation of political interest with affective ambivalence

##Merkel

#Wave4
cor.test(pol_int_w4, Merkel_amb_w4, use ="complete.obs") # negative correlation: r = -.08
#Wave6
cor.test(pol_int_w6, Merkel_amb_w6, use ="complete.obs") # negative correlation: r = -.08

##Schulz

#Wave4
cor.test(pol_int_w4, Schulz_amb_w4, use ="complete.obs") # negative correlation: r = -.11
#Wave6
cor.test(pol_int_w6, Schulz_amb_w6, use ="complete.obs") # negative correlation: r = -.10

##Average Ambivalence

#Wave4
cor.test(pol_int_w4, mean_amb_w4, use ="complete.obs") # negative correlation: r = -.11
#Wave6
cor.test(pol_int_w6, mean_amb_w6, use ="complete.obs") # negative correlation: r = -.11
...
cor <- wkp17 %>% 
  select(symb_id_w4,symb_extr_w4, aut_M, open_cons,trans_enh, nfc_M, pol_int_w4,
