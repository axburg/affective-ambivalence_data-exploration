...
wkp17 <- read.spss("J:/Work/GLES/03_Panel/07_Releases/ZA6804_v7-0-0/ZA6804_en_v7-0-0.sav",
...
wkp17$region <- wkp17$ostwest

wkp17$region <- factor(wkp17$region,
                       levels = c(0, 1),
...
###Association between negative and positive feelings
