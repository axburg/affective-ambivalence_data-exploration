...
wkp13 %>% select(symb_id_mean, pol_int_mean, CDU_amb_mean, SPD_amb_mean, FDP_amb_mean, GRUENE_amb_mean, LINKE_amb_mean) %>% 
...
CDU_M1 <- lm(rescale(CDU_amb_mean) ~ rescale(symb_id_mean), data = wkp13)
CDU_M2 <- lm(rescale(CDU_amb_mean) ~ rescale(symb_id_mean) + gend + age + edu + region + rescale(pol_int_mean), data = wkp13)

##SPD

SPD_M1 <- lm(rescale(SPD_amb_mean) ~ rescale(symb_id_mean), data = wkp13)
SPD_M2 <- lm(rescale(SPD_amb_mean) ~ rescale(symb_id_mean) + gend + age + edu + region + rescale(pol_int_mean), data = wkp13)

##FDP

FDP_M1 <- lm(rescale(FDP_amb_mean) ~ rescale(symb_id_mean), data = wkp13)
FDP_M2 <- lm(rescale(FDP_amb_mean) ~ rescale(symb_id_mean) + gend + age + edu + region + rescale(pol_int_mean), data = wkp13)

##Table OA5

tab_model(CDU_M1, CDU_M2,
          SPD_M1, SPD_M2,
          FDP_M1, FDP_M2,
          ...
          file = "tables/table_OA5.doc")

##GRUENE

GRUENE_M1 <- lm(rescale(GRUENE_amb_mean) ~ rescale(symb_id_mean), data = wkp13)
GRUENE_M2 <- lm(rescale(GRUENE_amb_mean) ~ rescale(symb_id_mean) + gend + age + edu + region + rescale(pol_int_mean), data = wkp13)

##LINKE

LINKE_M1 <- lm(rescale(LINKE_amb_mean) ~ rescale(symb_id_mean), data = wkp13)
LINKE_M2 <- lm(rescale(LINKE_amb_mean) ~ rescale(symb_id_mean) + gend + age + edu + region + rescale(pol_int_mean), data = wkp13)

##Table OA6

tab_model(GRUENE_M1, GRUENE_M2,
          LINKE_M1, LINKE_M2,
          show.intercept = FALSE,
          show.ci = FALSE,
          pred.labels = c("Political Ideology",
                          ...
                          "Region (1 = Western Germany)",
                          "Political Interest"),
          dv.labels = c("Green Party (1)", "Green Party (2)", "The LEFT(1)", "The LEFT (2)"),
          file = "tables/table_OA6.doc")
...
Fig_OA7a <- ggplot(wkp13, aes(x = symb_id_mean, y = CDU_amb_mean)) + 
  ...
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.25***", "b = - 0.21***"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(CDU_att_mean ~ symb_id_mean, data = wkp13)

Fig_OA7b <- ggplot(wkp13, aes(x = symb_id_mean, y = CDU_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Attitude") +
  ...
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = 0.72***", "b = - 0.01"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(CDU_amb_mean ~ CDU_att_mean, data = wkp13)

Fig_OA7c <- ggplot(wkp13, aes(x = CDU_att_mean, y = CDU_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_OA7d <- ggplot(wkp13, aes(x = symb_id_mean, y = CDU_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
...
plot_grid(Fig_OA7a, Fig_OA7b, Fig_OA7c, Fig_OA7d, labels = c('A', 'B', 'C', 'D'), label_size = 16)

ggsave("figures/figure_OA7.png")
...
Fig_OA8a <- ggplot(wkp13, aes(x = symb_id_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Ambivalence") +
  ...
  annotate("segment", x = 2.0, xend = 3.5, y = 0.3, yend = 0.7, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 4.5, xend = 6.0, y = 0.7, yend = 0.4, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.08***", "b = - 0.15***"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(SPD_att_mean ~ symb_id_mean, data = wkp13)

Fig_OA8b <- ggplot(wkp13, aes(x = symb_id_mean, y = SPD_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.29***", "b = - 0.16"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(SPD_amb_mean ~ SPD_att_mean, data = wkp13)

Fig_OA8c <- ggplot(wkp13, aes(x = SPD_att_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_OA8d <- ggplot(wkp13, aes(x = mean_symb_id, y = SPD_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Residual Ambivalence     ") +
...
plot_grid(Fig_OA8a, Fig_OA8b, Fig_OA8c, Fig_OA8d, labels = c('A', 'B', 'C', 'D'), label_size = 16)

ggsave("figures/figure_OA8.png")
...
Fig_OA9a <- ggplot(wkp13, aes(x = symb_id_mean, y = FDP_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Ambivalence") +
  ...
  annotate("segment", x = 2.0, xend = 3.5, y = 0.3, yend = 0.7, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 4.5, xend = 6.0, y = 0.7, yend = 0.4, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.29***", "b = - 0.04"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(FDP_att_mean ~ symb_id_mean, data = wkp13)

Fig_OA9b <- ggplot(wkp13, aes(x = symb_id_mean, y = FDP_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = 0.57***", "b = - 0.04"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(FDP_amb_mean ~ FDP_att_mean, data = wkp13)

Fig_OA9c <- ggplot(wkp13, aes(x = SPD_att_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_OA9d <- ggplot(wkp13, aes(x = mean_symb_id, y = FDP_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Residual Ambivalence     ") +
...
plot_grid(Fig_OA9a, Fig_OA9b, Fig_OA9c, Fig_OA9d, labels = c('A', 'B', 'C', 'D'), label_size = 16)

ggsave("figures/figure_OA9.png")
...
Fig_OA10a <- ggplot(wkp13, aes(x = symb_id_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Ambivalence") +
...
Fig_OA10b <- ggplot(wkp13, aes(x = symb_id_mean, y = GRUENE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = 0.47***", "b = - 0.32**"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(GRUENE_amb_mean ~ GRUENE_att_mean, data = wkp13)

Fig_OA10c <- ggplot(wkp13, aes(x = GRUENE_att_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_OA10d <- ggplot(wkp13, aes(x = mean_symb_id, y = GRUENE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Residual Ambivalence     ") +
...
plot_grid(Fig_OA10a, Fig_OA10b, Fig_OA10c, Fig_OA10d, labels = c('A', 'B', 'C', 'D'), label_size = 16)

ggsave("figures/figure_OA10.png")
...
Fig_OA11a <- ggplot(wkp13, aes(x = symb_id_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Ambivalence") +
...
Fig_OA11b <- ggplot(wkp13, aes(x = symb_id_mean, y = LINKE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.80***", "b = - 0.14"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(LINKE_amb_mean ~ LINKE_att_mean, data = wkp13)

Fig_OA11c <- ggplot(wkp13, aes(x = LINKE_att_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_OA11d <- ggplot(wkp13, aes(x = mean_symb_id, y = LINKE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Left-Right Self-placement",
       y = "Residual Ambivalence     ") +
...
plot_grid(Fig_OA11a, Fig_OA11b, Fig_OA11c, Fig_OA11d, labels = c('A', 'B', 'C', 'D'), label_size = 16)

ggsave("figures/figure_OA11.png")
...
wkp13 %>% select(symb_id_mean, CDU_amb_resid, SPD_amb_resid, FDP_amb_resid, GRUENE_amb_resid, LINKE_amb_resid) %>% 
  apa.cor.table(., filename = "tables/table_OA7.doc")
...
Fig_A12a <- ggplot(wkp13, aes(x = soc_id_mean, y = CDU_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_A12b <- ggplot(wkp13, aes(x = soc_id_mean, y = CDU_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Attitude") +
...
Fig_A12c <- ggplot(wkp13, aes(x = CDU_att_mean, y = CDU_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the CDU/CSU",
       y = "Ambivalence") +
...
Fig_A12d <- ggplot(wkp13, aes(x = soc_id_mean, y = CDU_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Residual Ambivalence") +
...
Fig_A13a <- ggplot(wkp13, aes(x = econ_id_mean, y = CDU_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_A13b <- ggplot(wkp13, aes(x = econ_id_mean, y = CDU_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Attitude") +
...
Fig_A13c <- ggplot(wkp13, aes(x = CDU_att_mean, y = CDU_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the CDU/CSU",
       y = "Ambivalence") +
...
Fig_A14a <- ggplot(wkp13, aes(x = soc_id_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Ambivalence") +
...
Fig_A14b <- ggplot(wkp13, aes(x = soc_id_mean, y = SPD_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = 0.37***", "b = - 0.41***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(SPD_amb_mean ~ SPD_att_mean, data = wkp13)

Fig_A14c <- ggplot(wkp13, aes(x = SPD_att_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the SPD",
       y = "Ambivalence") +
...
Fig_A14d <- ggplot(wkp13, aes(x = soc_id_mean, y = SPD_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Residual Ambivalence") +
...
Fig_A15a <- ggplot(wkp13, aes(x = econ_id_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Ambivalence") +
...
Fig_A15b <- ggplot(wkp13, aes(x = econ_id_mean, y = SPD_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.36***", "b = - 0.54***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(SPD_amb_mean ~ SPD_att_mean, data = wkp13)

Fig_A15c <- ggplot(wkp13, aes(x = SPD_att_mean, y = SPD_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the SPD",
       y = "Ambivalence") +
...
Fig_A15d <- ggplot(wkp13, aes(x = soc_id_mean, y = SPD_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Residual Ambivalence") +
...
Fig_A16a <- ggplot(wkp13, aes(x = soc_id_mean, y = FDP_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Ambivalence") +
  ...
  annotate("segment", x = 2.0, xend = 3.5, y = 0.3, yend = 0.7, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 4.5, xend = 6.0, y = 0.7, yend = 0.4, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.28***", "b = - 0.15***"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(FDP_att_mean ~ soc_id_mean, data = wkp13)

Fig_A16b <- ggplot(wkp13, aes(x = soc_id_mean, y = FDP_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = 0.43***", "b = - 0.36***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(FDP_amb_mean ~ FDP_att_mean, data = wkp13)

Fig_A16c <- ggplot(wkp13, aes(x = FDP_att_mean, y = FDP_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the FDP",
       y = "Ambivalence") +
...
Fig_A16d <- ggplot(wkp13, aes(x = soc_id_mean, y = FDP_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Residual Ambivalence") +
...
Fig_A17a <- ggplot(wkp13, aes(x = econ_id_mean, y = FDP_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Ambivalence") +
  ...
  annotate("segment", x = 2.0, xend = 3.5, y = 0.3, yend = 0.7, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 4.5, xend = 6.0, y = 0.7, yend = 0.4, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.47***", "b = - 0.10***"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(FDP_att_mean ~ econ_id_mean, data = wkp13)

Fig_A17b <- ggplot(wkp13, aes(x = econ_id_mean, y = FDP_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.76***", "b = - 0.57***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(FDP_amb_mean ~ FDP_att_mean, data = wkp13)

Fig_A17c <- ggplot(wkp13, aes(x = FDP_att_mean, y = FDP_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the FDP",
       y = "Ambivalence") +
...
Fig_A17d <- ggplot(wkp13, aes(x = soc_id_mean, y = FDP_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Residual Ambivalence") +
...
Fig_A18a <- ggplot(wkp13, aes(x = soc_id_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Ambivalence") +
...
Fig_A18b <- ggplot(wkp13, aes(x = soc_id_mean, y = GRUENE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Attitude") +
...
Fig_A18c <- ggplot(wkp13, aes(x = GRUENE_att_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the Green Party",
       y = "Ambivalence") +
...
Fig_A18d <- ggplot(wkp13, aes(x = soc_id_mean, y = GRUENE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Residual Ambivalence") +
...
Fig_A19a <- ggplot(wkp13, aes(x = econ_id_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Ambivalence") +
...
Fig_A19b <- ggplot(wkp13, aes(x = econ_id_mean, y = GRUENE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.45***", "b = - 0.98***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(GRUENE_amb_mean ~ GRUENE_att_mean, data = wkp13)

Fig_A19c <- ggplot(wkp13, aes(x = GRUENE_att_mean, y = GRUENE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the GReen Party",
       y = "Ambivalence") +
...
Fig_A19d <- ggplot(wkp13, aes(x = soc_id_mean, y = GRUENE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Residual Ambivalence") +
...
Fig_A20a <- ggplot(wkp13, aes(x = soc_id_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Ambivalence") +
...
Fig_A20b <- ggplot(wkp13, aes(x = soc_id_mean, y = LINKE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.20***", "b = - 0.25***"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(LINKE_amb_mean ~ LINKE_att_mean, data = wkp13)

Fig_A20c <- ggplot(wkp13, aes(x = LINKE_att_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
...
Fig_A20d <- ggplot(wkp13, aes(x = soc_id_mean, y = LINKE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Opposition to Immigration",
       y = "Residual Ambivalence") +
...
Fig_A21a <- ggplot(wkp13, aes(x = econ_id_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Ambivalence") +
  ...
  annotate("segment", x = 2.0, xend = 3.5, y = 0.3, yend = 0.7, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 4.5, xend = 6.0, y = 0.7, yend = 0.4, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(2.5, 6.0), y = c(-0.3, -0.3), label = c("b = 0.10***", "b = - 0.20***"), color = "red", size = 4, fontface = "bold")

##Ideology & Attitude

a = twolines(LINKE_att_mean ~ econ_id_mean, data = wkp13)

Fig_A21b <- ggplot(wkp13, aes(x = econ_id_mean, y = LINKE_att_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Attitude") +
  ...
  annotate("segment", x = 2.5, xend = 4.5, y = 4.0, yend = 5.0, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("segment", x = 5.4, xend = 7.2, y = 5.0, yend = 4.5, colour = "red", size = 1.0, alpha = 0.6, arrow = arrow()) +
  annotate("text", x = c(3.5, 6.8), y = c(3.2, 3.2), label = c("b = - 0.69***", "b = - 0.09"), color = "red", size = 4, fontface = "bold")

##Attitude and Ambivalence

a = twolines(LINKE_amb_mean ~ LINKE_att_mean, data = wkp13)

Fig_A21c <- ggplot(wkp13, aes(x = LINKE_att_mean, y = LINKE_amb_mean)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Attitude towards the GReen Party",
       y = "Ambivalence") +
...
Fig_A21d <- ggplot(wkp13, aes(x = soc_id_mean, y = LINKE_amb_resid)) + 
  geom_jitter(alpha = 0.02) + 
  geom_smooth() +
  labs(x = "Support for Low Taxes and Low Social Benefits",
       y = "Residual Ambivalence") +
...
ggsave("figures/figure_A21.png")




####Is ideology associated with changes in ambivalence over time?####


wkp13$CDU_amb_dif <- wkp13$CDU_amb_w6 -  wkp13$CDU_amb_w1
wkp13$SPD_amb_dif <- wkp13$SPD_amb_w6 -  wkp13$SPD_amb_w1
wkp13$FDP_amb_dif <- wkp13$FDP_amb_w6 -  wkp13$FDP_amb_w1
wkp13$GRUENE_amb_dif <- wkp13$GRUENE_amb_w6 -  wkp13$GRUENE_amb_w1
wkp13$LINKE_amb_dif <- wkp13$LINKE_amb_w6 -  wkp13$LINKE_amb_w1

t.test(wkp13$CDU_amb_dif, mu = 0) #ns
t.test(wkp13$SPD_amb_dif, mu = 0) #ns
t.test(wkp13$FDP_amb_dif, mu = 0) #ns
t.test(wkp13$GRUENE_amb_dif, mu = 0) #ns
t.test(wkp13$LINKE_amb_dif, mu = 0) # > 0

cor.test(wkp13$symb_id_mean, wkp13$CDU_amb_dif, use = "complete.obs") #ns
cor.test(wkp13$symb_id_mean, wkp13$SPD_amb_dif, use = "complete.obs") # r = .04
cor.test(wkp13$symb_id_mean, wkp13$FDP_amb_dif, use = "complete.obs") #ns
cor.test(wkp13$symb_id_mean, wkp13$GRUENE_amb_dif, use = "complete.obs") # r = -.05
cor.test(wkp13$symb_id_mean, wkp13$LINKE_amb_dif, use = "complete.obs") # r = .06
